...
## 관련 프로젝트
- [openclaw-kakao-talkchannel-plugin](http://gitlab.tepseg.com:8087/ai/openclaw-kakao.git): OpenClaw 카카오톡 채널 플러그인 — SSE 연결, 메시지 폴링/응답, 페어링을 자동 처리. OpenClaw에 플러그인 설치 후 `relayUrl`과 `relayToken`을 설정하면 바로 연동됩니다.
